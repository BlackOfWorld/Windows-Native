...
PHANDLE File_Create(PWCHAR fileName, DWORD Access, DWORD ShareMode, DWORD CreationDisposition, DWORD FlagsAndAttributes)
{
	...
	NTSTATUS status = NtCreateFile(&FileHandle, Access, &ObjectAttributes, &IoStatusBlock, NULL, FileAttributes, ShareMode, CreationDisposition, Flags, EaBuffer, EaLength);
